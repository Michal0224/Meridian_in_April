...
def opti_budget_tab(mmm):
    ...
    budget_all_tab.to_pickle('budget_all_tab.pkl')
...
def incremental_reve():
    ...
    inc_reve.to_pickle('inc_reve.pkl')
    
def incremental_reve_chart():
    inc_reve = pd.read_pickle('inc_reve.pkl')
